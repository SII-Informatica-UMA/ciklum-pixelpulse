...
import security.SecurityConfguration;
import usuarios.entities.PasswordReset;
import usuarios.entities.Usuario;
import usuarios.exceptions.CredencialesIncorrectas;
import usuarios.exceptions.TokenNoValidoException;
import usuarios.exceptions.UsuarioExistente;
import usuarios.exceptions.UsuarioInexistente;
import usuarios.repositories.PasswordResetRepo;
import usuarios.repositories.UsuarioRepo;
...
public class UsuarioService {
    ...
    public Usuario save(Usuario usuario) {
        ...
        user.ifPresent(u -> log.fine("Usuario autenticado: " + u.getUsername()));
