...
@DisplayName("En el servicio de Gestión y Ejercicios")
...
public class EntidadesApplicationTests {
    ...
    public class GetEjercicioConMockitoNestedTest {
        ...
        public void GetEjercicioNoExistenteTest() {
            mockServer.expect(
        ...
        public void GetEjercicioJWTConPermisoTest() throws JsonProcessingException {   //suponemos que el jwt60 es entrenador 1 y es dueño del ejercicio 1
        ...
        public void GetEjercicioJWTSinPermisoTest() {   //intentamos el mismo ejercicio con JWT sin permiso
            mockServer.expect(
                            requestTo(UriComponentsBuilder.fromUriString("http://localhost:9001/entrenador/1").build().toUri()))   //Vamos al microservicio de entrenadores a sacar los datos
                    .andExpect(method(HttpMethod.GET))
                    .andRespond(withStatus(HttpStatus.OK)
    ...
    public class GetEjercicioGeneralConMockitoNestedTest {
        @BeforeEach
        public void setup() {
            MockRestServiceServer mockServer = MockRestServiceServer.createServer(restTemplate);
            rutinaRepository.deleteAll();
        ...
        public void GetEjercicioJWTConPermisoTest() {   //suponemos que el jwt60 es entrenador 1 y es dueño del ejercicio 1
            mockServer.expect(
                            requestTo(UriComponentsBuilder.fromUriString("http://localhost:9001/entrenador/1").build().toUri()))   //Vamos al microservicio de entrenadores a sacar los datos
                    .andExpect(method(HttpMethod.GET))
                    .andRespond(withStatus(HttpStatus.OK)
    ...
    public class PutEjercicioConMockito {
        ...
        @Test
        @DisplayName("Devuelve error ejercicio no existe")
        public void PutEjercicioNoExistenteTest() {
            mockServer.expect(
                            requestTo(UriComponentsBuilder.fromUriString("http://localhost:9001/entrenador/1").build().toUri()))   //Vamos al microservicio de entrenadores a sacar los datos
                    .andExpect(method(HttpMethod.GET))
                    .andRespond(withStatus(HttpStatus.OK)
        ...
        public void PutEjercicioJWTConPermisoTest() {   //suponemos que el jwt60 es entrenador 1 y es dueño del ejercicio 1
            mockServer.expect(
                            requestTo(UriComponentsBuilder.fromUriString("http://localhost:9001/entrenador/1").build().toUri()))   //Vamos al microservicio de entrenadores a sacar los datos
                    .andExpect(method(HttpMethod.GET))
                    .andRespond(withStatus(HttpStatus.OK)
        ...
        @Test
        @DisplayName("Devuelve Error del ejercicio JWT sin permiso")
        public void PutEjercicioJWTSinPermisoTest() {   //intentamos el mismo ejercicio con JWT sin permiso
            mockServer.expect(
                            requestTo(UriComponentsBuilder.fromUriString("http://localhost:9001/entrenador/1").build().toUri()))   //Vamos al microservicio de entrenadores a sacar los datos
                    .andExpect(method(HttpMethod.GET))
                    .andRespond(withStatus(HttpStatus.OK)
    ...
    public class DeleteEjercicioConMockito {
        ...
        @Test
        @DisplayName("Devuelve error ejercicio no existe")
        public void DeleteEjercicioEjercicioNoExistenteTest() {
            mockServer.expect(
                            requestTo(UriComponentsBuilder.fromUriString("http://localhost:9001/entrenador/1").build().toUri()))   //Vamos al microservicio de entrenadores a sacar los datos
                    .andExpect(method(HttpMethod.GET))
                    .andRespond(withStatus(HttpStatus.OK)
        ...
        public void DeleteEjercicioJWTConPermisoTest() {   //suponemos que el jwt60 es entrenador 1 y es dueño del ejercicio 1
            mockServer.expect(
                            requestTo(UriComponentsBuilder.fromUriString("http://localhost:9001/entrenador/1").build().toUri()))   //Vamos al microservicio de entrenadores a sacar los datos
                    .andExpect(method(HttpMethod.GET))
                    .andRespond(withStatus(HttpStatus.OK)
        ...
        @Test
        @DisplayName("Devuelve Error del ejercicio JWT sin permiso")
        public void DeleteEjercicioJWTSinPermisoTest() {   //intentamos el mismo ejercicio con JWT sin permiso
            mockServer.expect(
                            requestTo(UriComponentsBuilder.fromUriString("http://localhost:9001/entrenador/1").build().toUri()))   //Vamos al microservicio de entrenadores a sacar los datos
                    .andExpect(method(HttpMethod.GET))
                    .andRespond(withStatus(HttpStatus.OK)
    ...
    public class GetRutinaIdConMockitoNestedTest {
        ...
        public void GetRutinaNoExistenteTest() {
            mockServer.expect(
                            requestTo(UriComponentsBuilder.fromUriString("http://localhost:9001/entrenador/1").build().toUri()))   //Vamos al microservicio de entrenadores a sacar los datos
                    .andExpect(method(HttpMethod.GET))
                    .andRespond(withStatus(HttpStatus.OK)
        ...
        public void GetRutinaJWTConPermisoTest() throws JsonProcessingException, URISyntaxException {   //suponemos que el jwt60 es entrenador 1 y es dueño del ejercicio 1
            ObjectMapper mapper = new ObjectMapper();
            ...
            mockServer.expect(
                            requestTo(new URI("http://localhost:"+port+"/entrenador/1")))    //Vamos al microservicio de entrenadores a sacar los datos
    ...
    public class PutRutinaConMockito {
        ...
        @Test
        @DisplayName("Devuelve error Rutina no existe")
        public void PutRutinaNoExistenteTest() throws URISyntaxException {
            mockServer.expect(
                            requestTo(new URI("http://localhost:9001/entrenador/1")))   //Vamos al microservicio de entrenadores a sacar los datos
                    .andExpect(method(HttpMethod.GET))
                    .andRespond(withStatus(HttpStatus.OK)
                            .contentType(MediaType.APPLICATION_JSON)
                            .body("{ \"idUsuario\": 60, \"telefono\": \"string\", \"direccion\": \"string\", \"dni\": \"string\", \"fechaNacimiento\": \"2024-05-31T09:08:45.560Z\", \"fechaAlta\": \"2024-05-31T09:08:45.560Z\", \"fechaBaja\": \"2024-05-31T09:08:45.560Z\", \"especialidad\": \"string\", \"titulacion\": \"string\", \"experiencia\": \"string\", \"observaciones\": \"string\", \"id\": 1 }"));
            ...
            var peticion = put("http", "localhost", port, rutina,"/rutina/" + 43781234, jwt60);
            var respuesta = testRestTemplate.exchange(peticion,
                    new ParameterizedTypeReference<RutinaDTO>() {
                    });
        ...
        public void PutRutinaJWTConPermisoTest() throws URISyntaxException {   //suponemos que el jwt60 es entrenador 1 y es dueño del ejercicio 1
            mockServer.expect(
                            requestTo(new URI("http://localhost:"+port+"/entrenador/1")))    //Vamos al microservicio de entrenadores a sacar los datos
                    .andExpect(method(org.springframework.http.HttpMethod.GET))
                    .andRespond(withStatus(HttpStatus.OK)
            ...
            var peticion = put("http", "localhost", port, rutina,"/rutina/" + idRut1, jwt60);
            var respuesta = testRestTemplate.exchange(peticion,
                    new ParameterizedTypeReference<RutinaDTO>() {
                    });
        ...
        @Test
        @DisplayName("Devuelve Error de la rutina JWT sin permiso")
        public void PutRutinaJWTSinPermisoTest() throws URISyntaxException {   //intentamos el mismo ejercicio con JWT sin permiso
            mockServer.expect(
                            requestTo(new URI("http://localhost:"+port+"/entrenador/1")))    //Vamos al microservicio de entrenadores a sacar los datos
                    .andExpect(method(org.springframework.http.HttpMethod.GET))
                    .andRespond(withStatus(HttpStatus.OK)
            ...
            Rutina rutina = new Rutina();
            rutina.setNombre("NuevoNombre");
            var peticion = put("http", "localhost", port,rutina, "/rutina/" + idRut1, jwt61);
            var respuesta = testRestTemplate.exchange(peticion,
                    new ParameterizedTypeReference<RutinaDTO>() {
                    });
    ...
    @Nested
    @DisplayName("Post /rutina")
    public class PostRutinaConMockito {
        @Test
        @DisplayName("Crear satisfactoriamente la rutina JWT con permiso")
        void PostRutinaJWTConPermisoTest() throws URISyntaxException {
            mockServer.expect(
                            requestTo(UriComponentsBuilder.fromUriString("http://localhost:9001/entrenador/1").build().toUri()))   //Vamos al microservicio de entrenadores a sacar los datos
                    .andExpect(method(HttpMethod.GET))
                    .andRespond(withStatus(HttpStatus.OK)
            ...
            var peticion = post("http", "localhost", port, rutina,"/rutina" ,"entrenador",60L, jwt60);
            var respuesta = testRestTemplate.exchange(peticion,
                    new ParameterizedTypeReference<RutinaNuevaDTO>() {
                    });
        ...
        @Test
        @DisplayName("Devuelve error al crear la rutina JWT sin permiso")
        void PostRutinaJWTSinPermisoTest() throws URISyntaxException {
            mockServer.expect(
                            requestTo(UriComponentsBuilder.fromUriString("http://localhost:9001/entrenador/1").build().toUri()))   //Vamos al microservicio de entrenadores a sacar los datos
                    .andExpect(method(HttpMethod.GET))
                    .andRespond(withStatus(HttpStatus.OK)
            ...
            RutinaNuevaDTO rutina = new RutinaNuevaDTO();
            rutina.setNombre("Nombre");
            var peticion = post("http", "localhost", port, rutina,"/rutina" ,"entrenador",61L, jwt61);
            var respuesta = testRestTemplate.exchange(peticion,
                    new ParameterizedTypeReference<RutinaNuevaDTO>() {
                    });
    ...
    @Nested
    @DisplayName("Post /ejercicio")
    public class PostEjercicioConMockito {
        @Test
        @DisplayName("Crear satisfactoriamente la rutina JWT con permiso")
        void PostEjercicioJWTConPermisoTest() throws URISyntaxException {
            mockServer.expect(
                            requestTo(UriComponentsBuilder.fromUriString("http://localhost:9001/entrenador/1").build().toUri()))   //Vamos al microservicio de entrenadores a sacar los datos
                    .andExpect(method(HttpMethod.GET))
                    .andRespond(withStatus(HttpStatus.OK)
            ...
            EjercicioNuevoDTO ejercicio = new EjercicioNuevoDTO();
            ejercicio.setNombre("Nombre");
            var peticion = post("http", "localhost", port, ejercicio,"/ejercicio" ,"entrenador",60L, jwt60);
            var respuesta = testRestTemplate.exchange(peticion,
                    new ParameterizedTypeReference<EjercicioNuevoDTO>() {
                    });
        ...
        @Test
        @DisplayName("Devuelve error al crear la rutina JWT sin permiso")
        void PostEjercicioJWTSinPermisoTest() throws URISyntaxException {
            mockServer.expect(
                            requestTo(UriComponentsBuilder.fromUriString("http://localhost:9001/entrenador/1").build().toUri()))   //Vamos al microservicio de entrenadores a sacar los datos
                    .andExpect(method(HttpMethod.GET))
                    .andRespond(withStatus(HttpStatus.OK)
            ...
            EjercicioNuevoDTO ejercicio = new EjercicioNuevoDTO();
            ejercicio.setNombre("Nombre");
            var peticion = post("http", "localhost", port, ejercicio,"/ejercicio" ,"entrenador",61L, jwt61);
            var respuesta = testRestTemplate.exchange(peticion,
                    new ParameterizedTypeReference<EjercicioNuevoDTO>() {
                    });
